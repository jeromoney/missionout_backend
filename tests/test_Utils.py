...
import unittest
import json
from utils import get_teamID_from_event, TEST_RESOURCE_STR, get_mission_email

ERROR_RESOURCE_STR = (
    '{"oldValue": {}, "updateMask": {}, "value": {"createTime": "2020-02-20T22:08:29.494223Z", '
...
class UtilsTest(unittest.TestCase):
    def test_get_teamID_from_event(self):
        ...
        self.assertIn("@", get_mission_email())
